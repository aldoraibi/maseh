...
- **استئناف بعد انتهاء الورق**: عند توقّف الطباعة (نفاد الورق أو خطأ) ينبّهك التطبيق ويغيّر أيقونته، وبمجرد وضع ورق يُكمل الطباعة تلقائياً دون الحاجة للذهاب للطابعة وضغط زرها — مع زر «متابعة» يدوي
